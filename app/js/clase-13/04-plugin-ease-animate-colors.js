/*
    *  -----------------------------------------------------------------------------------------------------------  *
    *  -----  /04-plugin-ease-animate-colors.js  --  /src/scripts/clase-13/04-plugin-ease-animate-colors.js  -----  *
    *  -----------------------------------------------------------------------------------------------------------  *
*/
...
(($) => {
    ...
    console.log('\n');
    console.warn('-----  04-plugin-ease-animate-colors.js  -----');
    console.log('\n');
    ...
    $linkAnim.on("click", function (e) {
        ...
        mostrarMensaje(`Animando con easing: ${easingValue}...`);
